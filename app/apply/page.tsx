    ...
    <div className="mx-auto max-w-2xl space-y-8 py-6">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <form action={applyAction} className="space-y-6">
          ...
          <button type="submit" className="w-full rounded-md bg-brand-700 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-800 sm:w-auto">
            Submit application
          </button>
        </form>
      </div>
